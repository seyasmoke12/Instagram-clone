...
return (
    ...
    >
        ...
        <Image src={post.imageURL}  objectFit={'cover'} alt='profile postes' w={'100%'} h={'100%'}/> 
    </GridItem>
        ...
        <ModalBody bg={'black'} pb={5}>
            ...
            >
                ...
                <Flex flex={1} flexDirection={'column'} px={10} display={{base:'none',md:'flex'}}>
                    ...
                    _hover={{bg: 'whiteAlpha',color:'red.600'}} borderRadius={4} p={1}>
                        <MdDelete size={20} cursor='pointer'/>
                    </Button>
                    )}
                    </Flex>
                    <Divider my={4} bg={'gray.500'} />
                    <VStack w={'full'} alignItems={'start'} maxH={'360px'} overflowY={'auto'}>
